          ...
          {photos.length > 0 ? photos.map((photo, i) => (
            ...
            >
              <img 
                ...
                className={`w-full h-auto object-cover transition-transform duration-1000 ${selectedPhotos.includes(photo.id) ? 'saturate-100' : 'saturate-100 md:saturate-75 md:hover:scale-103'}`} 
