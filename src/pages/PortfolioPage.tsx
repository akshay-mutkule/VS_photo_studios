  ...
  return (
    <div className="min-h-screen bg-[#FCFAF6] pt-32 text-[#1A1815]">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 pb-32">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 mb-20">
          <div className="space-y-4 max-w-xl">
            <div className="flex items-center gap-3">
              <div className="h-[2px] w-12 bg-gradient-to-r from-[#A37E43] to-[#B8975A]" />
              <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#A37E43] flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-[#B8975A]" /> SACRED TREASURES • PORTFOLIO SAGA
              </span>
            </div>
            <h1 className="text-5xl sm:text-7xl font-serif text-zinc-900 tracking-tight leading-none">
              Royal <span className="italic text-[#A37E43] font-light">Chronicles</span>
            </h1>
            <p className="text-zinc-600 font-light font-sans text-sm sm:text-base leading-relaxed">
              Browse through our premium collection of wedding ceremonies, royal pre-wedding shoots, family documentation, and traditional silk portraits.
            </p>
          </div>
          ...
          <div className="w-full md:w-auto">
            <div className="relative group w-full sm:w-80">
              ...
              <Input
                ...
                className="bg-white border-[#A37E43]/20 h-14 pl-14 pr-6 rounded-none text-[10px] uppercase tracking-widest font-semibold focus-visible:ring-1 focus-visible:ring-[#A37E43]"
              />
            </div>
          </div>
        </div>
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`snap-start shrink-0 text-[10px] uppercase tracking-[0.25em] font-bold px-6 sm:px-8 py-3.5 transition-all duration-300 rounded-none border ${
                filter === cat
                  ? 'bg-[#A37E43] border-transparent text-white shadow-md'
                  : 'bg-white border-[#A37E43]/15 text-zinc-500 hover:text-zinc-900 hover:border-[#A37E43]/45'
              }`}
            >
              {cat}
            </button>
        ...
        <div className="mt-32 text-center py-16 px-6 bg-white border border-[#A37E43]/15 rounded-none space-y-8 shadow-[0_15px_40px_rgba(163,126,67,0.04)] max-w-4xl mx-auto">
          ...
          <Link to="/booking">
            <Button className="bg-[#A37E43] hover:bg-[#B8975A] text-white px-12 h-16 rounded-none uppercase text-[10px] font-bold tracking-[0.3em] transition-all scroll-smooth shadow-md">
              START PLAN SESSION
            </Button>
          </Link>
        </div>
